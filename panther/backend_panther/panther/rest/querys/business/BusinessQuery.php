...
define("INSERT_PERSON", "INSERT INTO person (name, lastName, phone, document_type_id, country_id, state_id, city_id) VALUES (?, ?, ?, ?, ?, ?, ?)");

define("UPDATE_PERSON", "UPDATE person SET name=?, lastName=?, phone=?, document_type_id=?, country_id=?, state_id=?, city_id=? WHERE id=?");
